function validacion() {
    let number1 = document.querySelector('#selector-1').value;
    let number2 = document.querySelector('#selector-2').value;
    let number3 = document.querySelector('#selector-3').value;
